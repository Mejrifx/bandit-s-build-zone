...
const CartoonButton = ({ 
  ...
  return (
    <motion.a
      ...
      className={cn(
        "group relative inline-flex items-center justify-center overflow-hidden rounded-2xl px-8 py-4 text-xl font-black tracking-wide text-white shadow-[0_8px_0_0_rgba(0,0,0,0.2)] transition-all duration-200 active:shadow-none active:translate-y-2",
        isPrimary 
